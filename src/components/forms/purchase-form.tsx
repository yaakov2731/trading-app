...
// Can be embedded on /purchases/new or inside a modal dialog
// =============================================================================

const lineItemSchema = z.object({
  product_id:        z.string().min(1, 'Seleccioná un producto'),
  quantity_ordered:  z.number().positive().optional(),
  quantity_received: z.number().positive('La cantidad recibida debe ser mayor a 0'),
...
export interface PurchaseFormProps {
  ...
  onCancel?:    () => void
  /** When true, uses router.push after success instead of onSuccess callback */
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <Card padding="md">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <FormField label="N° de factura / remito">
            <Input {...register('invoice_number')} placeholder="Ej: FAC-0012345" />
          </FormField>
        ...
        <div className="flex items-center gap-6 text-sm text-slate-500">
          <span>
            <span className="font-semibold text-slate-900 tabular-nums">
              {totalUnits.toLocaleString('es-AR', { maximumFractionDigits: 3 })}
            </span>{' '}unidades
          </span>
          {totalAmount > 0 && (
            <span>Total:{' '}
